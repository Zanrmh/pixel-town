...
import { createEngine } from './pixelTown/main';
import { ENGINE_ACTION_DURATION } from './constants';
// định nghĩa một mutation (thao tác thay đổi dữ liệu) trong một ứng dụng Convex, có chức năng khởi tạo và thiết lập thế giới mặc định cho một trò chơi hoặc mô phỏng tên là "Pixel Town".
const init = mutation({
  args: {
...
async function getOrCreateDefaultWorld(ctx: MutationCtx) {
  ...
  await ctx.scheduler.runAfter(0, internal.pixelTown.main.runStep, {
    worldId,
