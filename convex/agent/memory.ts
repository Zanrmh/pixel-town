...
import { GameId, agentId, conversationId, playerId } from '../pixelTown/ids';
import { SerializedPlayer } from '../pixelTown/player';
...
export async function rememberConversation(
  ...
  const llmMessages: LLMMessage[] = [
    {
      role: 'user',
      content: `Bạn là ${player.name}, và bạn vừa kết thúc một cuộc trò chuyện với ${otherPlayer.name}. Tôi muốn bạn tóm tắt cuộc trò chuyện đưới góc nhìn của ${player.name} sử dụng đại từ nhân xưng ngôi thứ nhất là "tôi", và and thêm nếu bạn thích hoặc không thích sự tương tác này`,
    },
  ];
