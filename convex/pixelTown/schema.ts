...
// định nghĩa một bộ bảng cơ sở dữ liệu để lưu trữ dữ liệu trò chơi cho AI Town, một môi trường giống như trò chơi. Nó tổ chức dữ liệu để truy cập và quản lý hiệu quả, đồng thời tách dữ liệu thay đổi thường xuyên khỏi dữ liệu thay đổi không thường xuyên để cải thiện hiệu suất.
export const pixelTownTables = {
