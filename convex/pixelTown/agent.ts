...
//Xử lý hành vi của một nhân vật (agent) trong trò chơi, bao gồm việc tham gia vào các cuộc trò chuyện, di chuyển trong thế giới game, và thực hiện các hành động khác.
...
type AgentOperations = typeof internal.pixelTown.agentOperations;

export async function runAgentOperation(ctx: MutationCtx, operation: string, args: any) {
  let reference;
  switch (operation) {
    case 'agentRememberConversation':
      reference = internal.pixelTown.agentOperations.agentRememberConversation;
      break;
    case 'agentGenerateMessage':
      reference = internal.pixelTown.agentOperations.agentGenerateMessage;
      break;
    case 'agentDoSomething':
      reference = internal.pixelTown.agentOperations.agentDoSomething;
      break;
    default:
