// Đây là các hằng số được sử dụng để điều chỉnh hành vi của một ứng dụng hoặc hệ thống, có thể liên quan đến trò chơi, mô phỏng, hoặc tương tác giữa các agents
...
export const ACTIVITIES = [
  { description: 'Đang đọc sách', emoji: '📖', duration: 60_000 },
  { description: 'Đang mơ mộng', emoji: '🤔', duration: 60_000 },
  { description: 'Đang làm vườn', emoji: '🥕', duration: 60_000 },
];
