...
// Thành phần này cung cấp chức năng nhập và gửi tin nhắn trong trò chơi.
// Nó hiển thị hộp nhập tin nhắn, tên người chơi, và xử lý việc gửi tin nhắn đến server cũng như cập nhật trạng thái "đang nhập".
