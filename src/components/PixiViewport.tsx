...
// Thành phần này tạo ra một viewport (khung nhìn) cho ứng dụng PixiJS, cho phép người dùng di chuyển và phóng to/thu nhỏ nội dung hiển thị.
// Nó sử dụng thư viện pixi-viewport để cung cấp chức năng này.
